...
from .views import HomeView,home, StudentCreateView, StudentDeleteView, StudentUpdateView, StudentDetailView, StudentListView, student_list, student_add, student_detail, student_update,student_delete
